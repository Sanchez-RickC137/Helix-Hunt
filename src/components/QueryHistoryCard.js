// components/QueryHistoryCard.js
import React from 'react';

const QueryHistoryCard = ({ query, isDarkMode, onSelect }) => {
  return (
    <div 
    ...
    >
      <h3 className="text-lg font-semibold mb-2">Query from {new Date(query.timestamp).toLocaleString()}</h3>
